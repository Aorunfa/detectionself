...
from tools.ops import segment2box, xyxyxyxy2xywhr
...
from tools.common import check_version, colorstr
# from ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
from tools.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class BaseMixTransform:
    ...
    def __call__(self, labels):
        ...
        mix_labels = [self.dataset._load_image_and_label(i) for i in indexes]
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        if self.auto:  # minimum rectangle
            ...
            ratio = new_shape[1] / shape[1], new_shape[0] / shape[0]  # w, h ratios
